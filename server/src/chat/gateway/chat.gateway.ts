...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
	...
	async handleBlockUser(
		...
		this.server.to(roomId).emit('FriendBlocked', { senderReceiver: body, status: blockedFriends });
	}
	...
	async handleUserMuted(
		...
		this.server.to(roomId).emit('userHasBeenMuted', { mutedUser: body, channelName: roomId });
	}

...
const Wins = (props: Myprops) => {
    ...
    // const totalPlayers = useAppSelector(selectTotalPlayers);
    return <Statistics name="Wins" data={props.him.totalWins} />;
};
...
const Loss = (props: Myprops) => {
    ...
    // const totalPlayers = useAppSelector(selectTotalPlayers);
    return <Statistics name="Defeats" data={props.him.totalloss} />;
};
...
const TotalMatches = (props: Myprops) => {
    ...
    // const totalPlayers = useAppSelector(selectTotalPlayers);
    return <Statistics name="Total battles" data={props.him.totalMatches} />;
};
...
const Level = (props: Myprops) => {
    ...
    // const totalPlayers = useAppSelector(selectTotalPlayers);
    return <Statistics name="Level" data={props.him.level} />;
};
